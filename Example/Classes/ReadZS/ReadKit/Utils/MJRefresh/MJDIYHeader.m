...
@interface MJDIYHeader() {
    ...
    __unsafe_unretained FLAnimatedImageView *_loadingView;
}
...
- (FLAnimatedImageView *)loadingView {
    if (!_loadingView) {
        NSString *filePath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"refresh_loading@2x.gif"];
        NSData * imageData = [NSData dataWithContentsOfFile:filePath];
        FLAnimatedImageView *loadingView = [[FLAnimatedImageView alloc] initWithImage:[UIImage sd_animatedGIFWithData:imageData]];
